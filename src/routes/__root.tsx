  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 font-serif text-5xl text-sage-deep">Página não encontrada</h1>
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 font-serif text-4xl text-sage-deep">Algo não fluiu</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          Tivemos um pequeno contratempo. Tente novamente em instantes.
        </p>
