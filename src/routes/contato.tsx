    ...
    <>
      <section className="container-narrow py-16 md:py-24 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-muted-foreground">
          Prefere WhatsApp? Instagram? Ou uma primeira visita ao espaço? Todos os caminhos são
          bem-vindos.
        </p>
      </section>
        ...
        <div className="container-narrow grid gap-10 md:grid-cols-2">
          <div>
            ...
            <h2 className="display-serif text-4xl">
              Quando <span className="italic text-sage">nos visitar</span>
            </h2>
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Estamos em {SITE.address}. O endereço completo é enviado após confirmação de
              agendamento, para preservar a tranquilidade do espaço.
            </p>
...
const CONTACTS = [
  ...
  { icon: Mail, label: "Email", value: SITE.email, href: `mailto:${SITE.email}`, external: false },
  {
    ...
    label: "Localização",
    value: SITE.city,
    href: "https://maps.google.com/?q=Urubici+SC",
    external: true,
  },
];
