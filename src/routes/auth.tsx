      ...
      <div className="mx-auto max-w-md rounded-[2rem] border border-border bg-card p-10 shadow-elegant">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <label className="block">
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} minLength={6} required className={inp} />
          </label>
...
const inp = "mt-1.5 w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-sage focus:ring-1 focus:ring-sage";
